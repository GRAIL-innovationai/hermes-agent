...
SKILLS_GUIDANCE = (
    ...
    "Before creating a new skill, check existing skills (skills_list / skill_view) "
    "for one that already covers the job; if one does, update it with "
    "skill_manage(action='edit' or 'patch') instead of creating a near-duplicate. "
    "Only create a new skill when nothing existing overlaps.\n"
