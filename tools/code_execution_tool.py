                ...
                try:
                    ...
                    try:
                        ...
                        if tool_name == "read_file":
                            # Sandbox scripts need real content on repeat reads,
                            # not the model-facing dedup stub (#44843).
                ...
                # Enforce tool call limit
                    ...
                    try:
                        ...
                        try:
                            ...
                            dispatch_kwargs = {"task_id": task_id}
                            if tool_name == "read_file":
                                # Sandbox scripts need real content on repeat
                                # reads, not the model-facing dedup stub (#44843).
                                dispatch_kwargs["suppress_read_dedup"] = True
